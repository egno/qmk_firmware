...
[_ALPHA_COLEMAK] = LAYOUT(
        ...
        LSFT_T(KC_SCLN),  KC_Z, KC_X,    KC_C,    KC_D,                                                      XXXXXXX,    XXXXXXX,    XXXXXXX, XXXXXXX,  XXXXXXX,
                        LT(_SYM2, KC_BSPC), TD(TD_R_SPC_TAB_NAV), LT(_CFG, KC_ENT),     XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [_ALPHA_COLEMAK_R] = LAYOUT(
        ...
        KC_DOT,  KC_COMM, KC_H,    KC_K,  KC_V,                                                  XXXXXXX,    XXXXXXX,    XXXXXXX, XXXXXXX,  XXXXXXX,
    ...
    [_NAV] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                        TO(_ALPHA_COLEMAK), _______, LT(_CFG, KC_ENT),     XXXXXXX, MO(_CFG), XXXXXXX
    ),
    [_NUM] = LAYOUT(
        XXXXXXX,  KC_7,  KC_8,  KC_9,  KC_DOT,                                    KC_PPLS,  KC_P7,  KC_P8,  KC_P9, KC_PSLS,
        XXXXXXX,     KC_4,  KC_5,  KC_6,  KC_0,                                    KC_P0,  KC_P4,  KC_P5,  KC_P6, KC_PDOT,
        XXXXXXX,  KC_1,  KC_2,  KC_3,  KC_COMM,                                    KC_PMNS,  KC_P1,  KC_P2,  KC_P3, KC_PAST,
                                        TO(_ALPHA_COLEMAK), _______, LT(_CFG, KC_ENT),     KC_PEQL, KC_PENT, XXXXXXX
    ),
    [_FKEYS] = LAYOUT(
    ...
    [_CFG] = LAYOUT(
        DF(_ALPHA_COLEMAK), DF(_SYM3), DF(_FKEYS), XXXXXXX, DF(_GAME),                                XXXXXXX, XXXXXXX, XXXXXXX,DF(_ALPHA_COLEMAK_R), DF(_ALPHA_COLEMAK),
        XXXXXXX, DF(_SYM), TO(_NAV), TO(_NUM), XXXXXXX,                                XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, DF(_SYM2), XXXXXXX, XXXXXXX, XXXXXXX,                                XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                 TO(_ALPHA_COLEMAK), XXXXXXX, LT(_CFG, KC_ENT),     XXXXXXX, XXXXXXX, XXXXXXX
    ),
};
